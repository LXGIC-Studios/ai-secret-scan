...
![npm](https://img.shields.io/npm/v/ai-secret-scan)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-secret-scan)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Secret scanning and security vulnerability detection

Secret scanning utility. Detects and prevents hardcoded keys, tokens, and credentials.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-secret-scan.svg)](https://badge.fury.io/js/ai-secret-scan)
